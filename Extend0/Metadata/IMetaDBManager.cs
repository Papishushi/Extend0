...
namespace Extend0.Metadata
{
    ...
    /// </para>
    /// </remarks>
    public interface IMetaDBManager : IDisposable, IAsyncDisposable
    {
        /// <summary>
        /// Closes a managed table identified by <paramref name="tableId"/>.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Implementations should attempt to close every table and avoid throwing where possible.
        /// Use <see cref="CloseAllStrict"/> if failures must be surfaced.
        /// </remarks>
        void CloseAll();
        ...
        /// </summary>
        /// <remarks>
        /// Implementations may throw if closing a table fails.
        /// Use <see cref="CloseAll"/> for best-effort cleanup.
        /// </remarks>
        void CloseAllStrict();
        ...
        /// <param name="dstPolicy">Capacity policy applied to the destination table/column.</param>
        ...
        /// <param name="refsCol">Column index that stores the ref-vector.</param>
        /// <param name="parentRow">Row index in the parent table.</param>
